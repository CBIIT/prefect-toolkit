...
class CrdcDHMongoSecrets:
    ...
    """
    secret_name_dev = "bento/crdc-hub/dev2"
    secret_name_prod = "bento/crdc-hub/prod"
    # CRDC DataHub Mongo DB collection names
    submission_collection = "submissions"
    datarecord_collection = "dataRecords"
...
class CommonsRepo:
    ...
    ctdc: dict = field(
        default_factory=lambda: {
            "repo": "https://github.com/CBIIT/ctdc-model",
            "model_yaml": "model-desc/ctdc_model_file.yaml",
            "props_yaml": "model-desc/ctdc_model_properties_file.yaml",
            "tags_api": "https://api.github.com/repos/CBIIT/ctdc-model/tags",
